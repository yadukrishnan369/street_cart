...
class OrderDetailsItemsSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final activeItems = OrdersHelper.getActiveItems(order);
    final cancelledItems = OrdersHelper.getCancelledItems(order);
    ...
    return Column(
      ...
      children: [
        if (activeItems.isNotEmpty) ...[
          ...activeItems.map(
            (item) => _buildItemCard(context, item, isDark, theme, isDelivered),
          ),
        ],
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
            ...
            Row(
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(
                    color: CustomerAppColors.error.withValues(alpha: 0.08),
                    borderRadius: BorderRadius.circular(12.r),
                    border: Border.all(
                      color: CustomerAppColors.error.withValues(alpha: 0.15),
                    ),
                  ),
                  child: Text(
                    'Cancelled',
                ...
                if (item.refundStatus == 'pending') ...[
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      color: CustomerAppColors.warning.withValues(alpha: 0.08),
                      borderRadius: BorderRadius.circular(12.r),
                      border: Border.all(
                        color: CustomerAppColors.warning.withValues(
                          alpha: 0.15,
                        ),
                      ),
                    ),
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      color: CustomerAppColors.success.withValues(alpha: 0.08),
                      borderRadius: BorderRadius.circular(12.r),
                      border: Border.all(
                        color: CustomerAppColors.success.withValues(
                          alpha: 0.15,
                        ),
                      ),
                    ),
          ...
          if (isDelivered && item.status != 'cancelled') ...[
            SizedBox(height: 16.h),
            Row(
              children: [
                // Review Button
