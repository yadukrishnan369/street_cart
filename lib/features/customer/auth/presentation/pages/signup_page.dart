...
import 'package:street_cart/features/customer/auth/presentation/bloc/signup_ui_cubit.dart';
                        ...
                        if (state is AuthSuccess) {
                          if (state.isNewUser) {
                            ...
                            Navigator.pushReplacement(
                              ...
                              MaterialPageRoute(
                                builder: (_) => HomePage(
                                  showProfileModal: !state.isProfileCompleted,
                                ),
                              ),
                            );
                          }
                          ...
                          context
                              .read<SignupUiCubit>()
                              .setVerificationSheetShowing(true);
                          ...
                          AppLogger.error(
                            "AuthError state reached: ${state.message}",
                          );
                          CustomSnackBar.show(
                            context,
