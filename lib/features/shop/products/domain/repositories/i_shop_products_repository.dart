...
abstract class IShopProductsRepository {
  Stream<List<ProductModel>> getShopProducts(String shopId);
  Future<void> addProduct(ProductModel product, List<VariantImageDraft> variantDrafts);
  Future<void> updateProduct(ProductModel product, List<VariantImageDraft> variantDrafts);
