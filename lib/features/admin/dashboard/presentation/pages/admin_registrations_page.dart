  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      providers: [
        ...
        BlocProvider(create: (_) => AdminRegistrationsUiCubit()),
      ],
      child: BlocBuilder<AdminRegistrationsUiCubit, AdminRegistrationsUiState>(
                        ...
                        return SingleChildScrollView(
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                _buildBackRow(context, uiState.anyChanges),
